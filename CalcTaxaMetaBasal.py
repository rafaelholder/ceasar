...
def CalcularTaxaBasal(idade, altura, peso, sexo, fatorAtvFisica):
...
#MOSTRANDO A TAXA
TMB= CalcularTaxaBasal(idade, altura, peso, sexo, fatorAtvFisica)
print(f'Sua taxa metabólica basal é de: {str(TMB)}')
